...
const jobs = [
  ...
  },
  {
    ...
    location: "Remote (Winnipeg, Canada)",
    description: "Diligently worked at improving all facets of the site through the whole technology stack, including developing a major site feature in the form of a external API integration with Facebook's Graph API. Another major feature was creating a sign-up experience that gathered the users interests and preferences.",
...
const education = [
  ...
  },
  {
    ...
    description: "Covered the core principles and concepts behind programing and computer science through C++, such as OOP and algorithmic thinking. Culminating in independently learning C# and managing a team of students to create a point and click adventure game.",
    tags: [ "C++", "C#", "OOP"],
    url: false,
    link: false,
  }
