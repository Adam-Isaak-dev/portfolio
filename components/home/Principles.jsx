...
export function Panel(props) {
  return (
    <div className="sm:w-80 sm:h-80 w-64 h-80 mt-10 mx-3 bg-neutral-800 border-solid border-4 border-neutral-700 transition duration-150 ease-in-out hover:-translate-y-5 focus:-translate-y-5 relative">
