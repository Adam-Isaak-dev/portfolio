  ...
  return (
    <div className="bg-neutral-900">
      <div className="mx-auto max-w-7xl lg:py-30 md:py-20 sm:py-15 py-10 flex flex-col justify-center items-center">
        ...
        <div className="h-24 xl:max-w-6xl lg:max-w-4xl md:max-w-2xl max-w-full flex items-center motion-safe:overflow-hidden motion-reduce:overflow-scroll bg-slate-900 md:rounded-lg border-solid border-cyan-900 md:border-4 border-y-4">
          <div className="flex">
